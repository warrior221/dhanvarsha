...
-- CreateEnum
CREATE TYPE "AttributeInputType" AS ENUM ('CHECKBOX', 'SELECT');

-- CreateEnum
CREATE TYPE "OtpChannel" AS ENUM ('EMAIL', 'WHATSAPP');

-- CreateEnum
CREATE TYPE "OtpPurpose" AS ENUM ('EMAIL_VERIFICATION', 'PHONE_VERIFICATION', 'COD_CONFIRMATION', 'PASSWORD_RESET');
...
CREATE TABLE "Product" (
    ...
    "isReadymade" BOOLEAN NOT NULL DEFAULT false,
...
CREATE TABLE "Attribute" (
    ...
    "name" TEXT NOT NULL,
    "slug" TEXT NOT NULL,
    "inputType" "AttributeInputType" NOT NULL DEFAULT 'CHECKBOX',
...
-- CreateIndex
CREATE INDEX "Product_isReadymade_idx" ON "Product"("isReadymade");
